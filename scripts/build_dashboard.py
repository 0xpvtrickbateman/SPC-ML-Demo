...
def make_dashboard(schema=DEFAULT_SCHEMA):
    ...
    drift=page("drift","2 · Detect drift",[
        ...
        table("input_detail","input_change","Input coverage and diagnostic evidence",[("series_id","Queue"),("feature","Input"),("reference_start","Training from"),("reference_end","Training through"),("window_start","Current from"),("window_end","Current through"),("reference_n","Finite training rows"),("current_n","Finite current rows"),("missing_rate","Invalid or missing rate"),("shift_score","Shift distance"),("status","Assessment")],23,6),
    ])
